    ...
    render() {
        return (
            <div>
                ...
                <ul style={{listStyleType: 'none', display: 'block', float: 'left', marginRight: '255px'}}><h2>Kraje: </h2>
                    <li>英国 Anglia</li>
                    <li>日本 Japonia</li>
                    <li>加拿大 Kanada</li>
                    <li>德国 Niemcy</li>
                ...
                <ul style={{listStyleType: 'none', display: 'block', float: 'left', marginRight: '255px'}}><h2>Owoce: </h2>
                    <li>西瓜 arbuz</li>
                    <li>苹果 jabłko</li>
                    <li>荔枝 liczi</li>
                ...
                <ul style={{listStyleType: 'none', display: 'block', float: 'left', marginRight: '255px'}}><h2>Kolory: </h2>
                    ...
                    <li>橙色 chéngsè - pomarańczowy</li></ul>
            </div>
        );
    }
}
